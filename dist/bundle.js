 ...
 // from Call
  ...
  // import 'reflect-metadata';
    ...
    AppComponent.prototype.init = function() {
      var _this = this;
      console.log(Reflect);
      var wallpaperPromise = this.wallpaperService.getRandom().then((function(path) {
        _this.currentWallpaper = path;
        _this.setWallpaper(path);
      }));
      var prayerTimesPromise = this.prayerTimesService.getPrayerTimes().then((function(data) {
  ...
  function render(instance) {
    var metadata = Reflect.getMetadata("component", AppComponent);
    var selector = metadata.selector;
    var template = metadata.template;
    var HTMLMarkup = renderTemplate(template, instance);
  ...
  function init() {
    document.onreadystatechange = function() {
      if ("complete" === document.readyState) initComponent(AppComponent);
    };
  }
  init();
})();
