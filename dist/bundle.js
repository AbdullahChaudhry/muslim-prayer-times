 ...
 // Adjust hours
  ...
  var AppComponent = function() {
    ...
    AppComponent.prototype.onInit = function() {
      var _this = this;
      this.wallpaperService.getRandom().then((function(path) {
        _this.currentWallpaper = path;
        _this.setWallpaper(path);
      }));
      this.prayerTimesService.getPrayerTimes().then((function(data) {
        _this.render(data);
      }));
    };
    ...
    AppComponent.prototype.render = function(data) {
